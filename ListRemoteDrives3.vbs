...
Dim objFSO
Dim objWBem, objSWbemServiceD
Dim objFileList
Dim objFile
Dim objRegistry
Dim regpath2enumerate
Dim colProc, oProcess, subkey, regpath, regentry, dapath
Dim sUser, sDomain, arrRegKeys, arrKeyNames, lngRtn, objSID, arrComputers
Dim strSourceList, strSaveToFile, strDrive, strFolder

' ********** User Variables
strSaveToFile = "PCtoTest_out10.txt"
strSourceList = "PCtoTest10.txt"
...
If objFSO.FolderExists(strDirectory) Then
	...
	If objFSO.FileExists(strDirectory & "\" & strSourceList) Then
		...
		'	WScript.Echo "Processing " & strComputer 
			...
			On Error GoTo 0 
			If (VarType(objSWbemServiceD) = 0) And (numErr = 0) Then numErr = 70
			...
			Select Case numErr
				...
				End If
				Case Else
					WScript.Echo   "======================== " & strComputer & " Error " & numErr & " " & strErr			
			End Select
